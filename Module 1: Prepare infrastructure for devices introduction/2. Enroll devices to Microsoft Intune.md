...
- **Configure Microsoft Entra ID device settings** Path: `Microsoft Entra admin center → Devices → Device settings`
  - **Define enrollment restrictions** limit platforms, OS versions, and number of devices per user `Intune → Devices → Enrollment → Enrollment restrictions`
  - **Define enrollment managers** - delegate enrollment permissions for shared or kiosk devices `Intune → Devices → Enrollment → Enrollment managers`
  - **Define terms and conditions** - require user acceptance during enrollment `Intune → Devices → Enrollment → Terms and conditions`
  - **Configure device categories** - tag devices for policy targeting during enrollment `Intune → Devices → Enrollment → Device categories`
